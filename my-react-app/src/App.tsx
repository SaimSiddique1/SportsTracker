...
const featuredPlayerCatalog: Record<string, { name: string; team: string; goals: number; assists: number; imageUrl: string }> = {
  "lionel messi": { name: "Lionel Messi", team: "Inter Miami", goals: 18, assists: 11, imageUrl: "https://a.espncdn.com/i/headshots/soccer/players/full/45843.png" },
  "erling haaland": { name: "Erling Haaland", team: "Manchester City", goals: 21, assists: 4, imageUrl: "https://a.espncdn.com/i/headshots/soccer/players/full/253989.png" },
  "kylian mbappe": { name: "Kylian Mbappe", team: "Real Madrid", goals: 27, assists: 6, imageUrl: "https://a.espncdn.com/i/headshots/soccer/players/full/231388.png" },
  "jude bellingham": { name: "Jude Bellingham", team: "Real Madrid", goals: 15, assists: 10, imageUrl: "https://a.espncdn.com/i/headshots/soccer/players/full/303663.png" },
  "mohamed salah": { name: "Mohamed Salah", team: "Liverpool", goals: 22, assists: 12, imageUrl: "https://a.espncdn.com/i/headshots/soccer/players/full/173896.png" },
  "harry kane": { name: "Harry Kane", team: "Bayern Munich", goals: 24, assists: 7, imageUrl: "https://a.espncdn.com/i/headshots/soccer/players/full/142200.png" },
  "vinicius junior": { name: "Vinicius Junior", team: "Real Madrid", goals: 17, assists: 9, imageUrl: "https://a.espncdn.com/i/headshots/soccer/players/full/280101.png" },
  "bukayo saka": { name: "Bukayo Saka", team: "Arsenal", goals: 16, assists: 11, imageUrl: "https://a.espncdn.com/i/headshots/soccer/players/full/290846.png" },
};
...
function AppLayout() {
  ...
  const [featuredPlayers, setFeaturedPlayers] = useState([
    { name: "Lionel Messi", team: "Inter Miami", goals: 18, assists: 11, imageUrl: "https://a.espncdn.com/i/headshots/soccer/players/full/45843.png" },
    { name: "Erling Haaland", team: "Manchester City", goals: 21, assists: 4, imageUrl: "https://a.espncdn.com/i/headshots/soccer/players/full/253989.png" },
  ]);
        ...
        const nextFeaturedPlayers = Array.isArray(contentData.contentModeration?.featuredPlayers)
          ? contentData.contentModeration.featuredPlayers
            .map((playerName: string) => featuredPlayerCatalog[playerName.trim().toLowerCase()] || {
              ...
              goals: 0,
              assists: 0,
              imageUrl: "https://via.placeholder.com/128x128.png?text=Player",
            })
            .slice(0, 2)
          : [];
